...
function EventRegisterPage({ title }) {
  ...
  return (
    <>
          <div id='CygnusTeam' className='w-full h-auto flex flex-col justify-start items-center gap-0 bg-[#890304] bg-royalbg bg-cover bg-repeat'>
                <MainLayout>
                  <div className="w-full h-auto flex flex-col justify-start items-center gap-0 font-serif">
                    <ResTitlePagelayout className={"justify-start ]"} title={"Register"}>
                      <div className="flex justify-between items-start w-full max-w-5xl h-auto gap-8 p-6 md:p-8 rounded-2xl mb-10 order-1 md:order-2">
                    <EventRegister  loggedInUser={user} eventType="team" maxParticipants={teammates} />
                        <div className="w-auto h-auto flex flex-col justify-start items-center pt-14 gap-6">
          ...
          <div className="w-full h-[400px]">
            <div className=" relative w-full h-full flex flex-col justify-center items-center p-10">
                ...
                <div className="absolute inset-0 flex flex-col justify-end items-start gap-[2px] event-border-two overflow-hidden z-50">
                        ...
                        <div> <p className="text-[22px] font-serif w-64 text-center text-[#E1CA6D]">Echoes of the Past: A Debate on Tradition</p></div>
                        </div>
                        </div>
